...
def cluster_num_iter(all_dataset, cluster_cnts, dcs, fair_tolerances,
    ...
    create_excel_files(all_dataset, columns, project_path)  # Create Excel files
...
if __name__ == '__main__':
    project_path = 'E:\\work\\fair_cluster\\current_work\\experiments\\FDPC6_4_fairUpperBound\\'
    all_dataset = ['adult', 'abalone', 'Wholesale', 'Rice', 'hcvdat0',
                   'obesity', 'dermatology', 'Room_Occupancy_Estimation']

    # 'Wholesale','hcvdat0',  'obesity', 'dermatology',
    # 'drug_consumption','Room_Occupancy_Estimation'
    # 'liver_disorder', 'Wholesale', 'hcvdat0', 'Rice', 'obesity'
    # 'abalone', 'Rice',
    # 'adult', 'athlete', 'Room_Occupancy_Estimation', 'creditcard'

    # 淘汰： vertebral ,heart_failure_clinical, 'dabestic', 'drug', 'census1990'
    cluster_cnts = [6]
    dcs = [0.02]
    fair_tolerances = [0.02, 0.04, 0.06, 0.08, 0.1]
